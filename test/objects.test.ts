...
describe('Keys<T>', () => {
    ...
    it('should fix keyof any = string | number | symbol', () => {
    ...
    it('should behave like keyof unknown = never', () => {
    ...
    it('should fix keyof never = string | number | symbol', () => {
...
describe('Values<T>', () => {
    ...
    it('should behave like any[keyof any] = any', () => {
    ...
    it('should behave like unknown[keyof unknown] = never', () => {
    ...
    it('should behave like never[keyof never] = never', () => {
...
describe('Join', () => {
    ...
    it('should join universal types', () => {
    ...
    it('should fulfil prerequisite Is<{ a: 1 } & { b: 2 }, { a: 1, b: 2 }> extends false', () => {
        type Actual = { a: 1 } & { b: 2 };
...
describe('Paths', () => {
    ...
    it('should work for universal types T = any | unknown | never', () => {
        assertType<Is<Paths<any>, any>>();
        assertType<Is<Paths<never>, never>>();
        assertType<Is<Paths<unknown>, unknown>>();
    });

    it('should work for type T = {}', () => {
        type Actual = Paths<{}>;
        type Expected = {};
        assertType<Is<Actual, Expected>>();
    });

    it('should work if a property value is never', () => {
        type Actual = Paths<{
            b: never;
        }>;
        type Expected = {
